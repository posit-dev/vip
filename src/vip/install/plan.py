...
def build_uninstall_plan(
    *,
    ...
    `{"dnf", "apt", "zypper"}` is silently omitted from
    `system_remove_commands` — this function has no removal syntax for it, so
    those packages are left for the caller to notice and handle manually.
