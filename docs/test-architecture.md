...
None of the four outcomes above is "an unhandled framework error". If a client call raises a
`VipError`, let it propagate out of the step rather than catching it -- the report should show
the real cause, not a laundered skip or warning.
